...
@interface UserMesaageinfoController (){
...
@implementation UserMesaageinfoController
...
-(void)contentView{
    ...
    oneBut.tag=1;
    [oneBut addTarget:self action:@selector(selectFunc:) forControlEvents:UIControlEventTouchUpInside];
    ...
    towBut.tag=2;
    [towBut addTarget:self action:@selector(selectFunc:) forControlEvents:UIControlEventTouchUpInside];
    ...
    UIButton *OutBut=[[UIButton alloc]initWithFrame:CGRectMake(30,375, SIZE_WIDTH-60, 40)];
...
-(void)savegButtonAction{
    ...
    [USER_DEFAULT setObject:userExpected.text forKey:@"yunqi"];
    [USER_DEFAULT setObject:strintstatus forKey:@"jitai"];
    [USER_DEFAULT setObject:userNameField.text forKey:@"nickname"];
    [USER_DEFAULT setObject:strSex forKey:@"sex"];
